...
from .iqasmlex import IqasmLexer
...
class IqasmParser(object):
    tokens = IqasmLexer.tokens
    def __init__(self, debug=False):
        self.parser = yacc.yacc(module=self, debug=debug)
        self.parsed_nodes = []
        self.lexer =  IqasmLexer()
    
    def parse(self, input : str):
        self.parsed_nodes = self.parser.parse(input, lexer=IqasmLexer())
